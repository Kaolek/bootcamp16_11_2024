...
print(f"Squred: {squred}")  # Squred: [1, 4, 9, 16, 25]
...
even_add = ['parzysta' if x % 2 == 0 else 'nieparzysta' for x in numbers]
print(
    f"Parzyste - Nieparzyste: {even_add}")  # Parzyste - Nieparzyste: ['nieparzysta', 'parzysta', 'nieparzysta', 'parzysta', 'nieparzysta']
